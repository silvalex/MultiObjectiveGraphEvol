...
run.prefix <- sprintf("run%s_2009/", args[1])
newops.prefix <- "2009-graph-newops-dataset%s/"
graph.prefix <- "2009-graph-dataset%s/"
...
pdf(sprintf("timePlot%s_2009.pdf",args[1]), width=10)
...
pdf(sprintf("fitnessPlot%s_2009.pdf",args[1]), width=10)
